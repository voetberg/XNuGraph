...
class ProbedNetwork: 
    ...
    def step_network(self, data, message_passing_steps=1, apply_softmax=False): 
        """
    ...
    def stepped_loss(self, input_decoded, encoder_decoded, planar_decoded, nexus_decoded, output): 
        return { 
            ...
            "nexus_decoded": {i: self.loss(output, planar_decoded[i]) for i in nexus_decoded.keys()}, 
    ...
    def stepped_explaination(self, input_decoded, encoder_decoded, planar_decoded, nexus_decoded, output): 
        return { 
            ...
            "nexus_to_decoder": self.calculate_percent_explained(nexus_decoded[-1], output)
        }
